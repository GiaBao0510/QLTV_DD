...
buildPrintableData(List<BaoCaoPhieuXuat_model> data,pw.Font font, Map<String, dynamic> thongTinTinhTong ) => pw.Container(
  child: pw.Table(
    ...
    children: [
      ...
      ...data.map((item) => pw.TableRow(
        children: [
          pw.Text('${item.PHIEU_XUAT_MA}', style: pw.TextStyle(fontSize: 7, font: font)),
