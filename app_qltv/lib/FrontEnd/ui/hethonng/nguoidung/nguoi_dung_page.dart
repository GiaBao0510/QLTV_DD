...
class _NguoiDungPageState extends State<NguoiDungPage>{
  ...
  Future<void> _loadNguoiDung() async {
    _nguoidungFuture = Provider.of<NguoiDungManager>(context, listen: false).fetchNguoiDungs();
                          ...
                          showDialog(
                            ...
                            builder: (BuildContext context) {
                              return AlertDialog(
                                ...
                                content: Text("Bạn có chắc chắn muốn xóa người dùng ${nguoidung.userTen?.toUpperCase()}?"),
                                actions: <Widget>[
                                  TextButton(
                                    onPressed: () {
                                  ...
                                  TextButton(
                                    onPressed: () async {
                                      ...
                                      await nguoidungManager.deleteNguoiDung(nguoidung.userId!); // Use `loaiId` directly
                                      Navigator.of(context).pop(); // Close the dialog
