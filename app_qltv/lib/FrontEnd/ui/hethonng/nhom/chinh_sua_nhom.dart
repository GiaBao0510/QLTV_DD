...
class _ChinhSuaNhomScreenState extends State<ChinhSuaNhomScreen> {
  ...
  void initState() {
    super.initState();
    _editedNhom =
        widget.nhom; // Initialize _editedNhomVang with widget's nhomVang
  }
  ...
  Future<void> _saveForm(BuildContext context) async {
    ...
    try {
      ...
      await nhomManager.updateNhom(
          _editedNhom.groupId as String,
          _editedNhom.groupMa as String,
          _editedNhom.groupTen as String,
          _editedNhom.biKhoa as bool,
          _editedNhom.lyDoKhoa as String,
          _editedNhom.suDung as bool);
