                ...
                ExpansionTile(
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: ListTile(
                        leading: const Icon(CupertinoIcons.settings),
                        title: const Text('Loại Vàng', style: TextStyle(fontWeight: FontWeight.bold)),
                        onTap: () {
                          Navigator.push(
                            context,
                    ...
                    Padding(
                      ...
                      child: ListTile(
                        leading: const Icon(CupertinoIcons.settings),
                        title: const Text('Nhóm Vàng', style: TextStyle(fontWeight: FontWeight.bold)),
                        onTap: () {
                          Navigator.push(
                            context,
                    ...
                    Padding(
                      ...
                      child: ListTile(
                        leading: const Icon(CupertinoIcons.settings),
                        title: const Text('Hàng Hóa', style: TextStyle(fontWeight: FontWeight.bold)),
                        onTap: () {
                          Navigator.push(
                            context,
                    ...
                    Padding(
                      ...
                      child: ListTile(
                        leading: const Icon(CupertinoIcons.settings),
                        title: const Text('Kho', style: TextStyle(fontWeight: FontWeight.bold)),
                        onTap: () {
                          // Handle Kho tap
                        },
                      ),
                    ...
                    Padding(
                      ...
                      child: ListTile(
                        leading: const Icon(CupertinoIcons.settings),
                        title: const Text('NCC', style: TextStyle(fontWeight: FontWeight.bold)),
                        onTap: () {
                          Navigator.push(
                            context,
                    ...
                    Padding(
                      ...
                      child: ListTile(
                        leading: const Icon(CupertinoIcons.settings),
                        title: const Text('Đơn Vị', style: TextStyle(fontWeight: FontWeight.bold)),
                        onTap: () {
                          // Handle Đơn Vị tap
                        },
                      ),
                ...
                ExpansionTile(
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: ListTile(
                        leading: const Icon(CupertinoIcons.bell),
                        title: const Text('Nhóm Người Dùng', style: TextStyle(fontWeight: FontWeight.bold)),
                        onTap: () {
                    ...
                    Padding(
                      ...
                      child: ListTile(
                        leading: const Icon(CupertinoIcons.bell),
                        title: const Text('Người Dùng', style: TextStyle(fontWeight: FontWeight.bold)),
                        onTap: () {
                    ...
                    Padding(
                      ...
                      child: ListTile(
                        leading: const Icon(CupertinoIcons.bell),
                        title: const Text('Quản lý quyền', style: TextStyle(fontWeight: FontWeight.bold)),
                        onTap: () {
                          _request_permission();
                        },
                      ),
                ...
                ExpansionTile(
                  ...
                  children: <Widget>[
                    Padding(
                      ...
                      child: ListTile(
                        leading: const Icon(CupertinoIcons.bell),
                                                title: const Text('Báo Cáo Phiếu Xuất', style: TextStyle(fontWeight: FontWeight.bold)),
                        onTap: () {
                    ...
                    Padding(
                      ...
                      child: ListTile(
                        leading: const Icon(CupertinoIcons.bell),
                        title: const Text('Báo Cáo Tồn Kho Loại Vàng', style: TextStyle(fontWeight: FontWeight.bold)),
                        onTap: () {
                    ...
                    Padding(
                      ...
                      child: ListTile(
                        leading: const Icon(CupertinoIcons.bell),
                        title: const Text('Báo Cáo Tồn Kho Vàng', style: TextStyle(fontWeight: FontWeight.bold)),
                        onTap: () {
                          // Handle Báo Cáo Tồn Kho Vàng tap
                        },
                      ),
                    ),
                    Padding(
                      ...
                      child: ListTile(
                        leading: const Icon(CupertinoIcons.bell),
                        title: const Text('Báo Cáo Tồn Theo Nhóm Vàng', style: TextStyle(fontWeight: FontWeight.bold)),
                        onTap: () {
                          // Handle Báo Cáo Tồn Theo Nhóm Vàng tap
                        },
                      ),
                    ),
                  ],
              ...
              child: const Row(
                ...
                children: [
                  Expanded(
                    ...
                    child: Text(
                      'Đăng xuất',
                      style: TextStyle(fontWeight: FontWeight.bold, fontSize: 18, fontFamily: 'Align'),
                    ),
                  ),
                  Expanded(
                    flex: 1,
