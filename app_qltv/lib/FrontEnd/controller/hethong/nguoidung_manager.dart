...
class NguoiDungManager with ChangeNotifier {
  ...
  Future<List<NguoiDung>> fetchNguoiDungs() async {
    ...
    if (response.statusCode == 200) {
      ...
      List<NguoiDung> nguoiDungList = jsonList.map((e) => NguoiDung.fromJson(e)).toList(); 
  ...
  void updateNguoiDung(NguoiDung updatedNguoiDung) {
    final index = _nguoiDungs.indexWhere((nguoiDung) => nguoiDung.userId == updatedNguoiDung.userId);
    if (index != -1) {
