...
// // // class BaocaophieumuaManage with ChangeNotifier{
// // //   List<BaoCaoPhieuMua> _PhieuMuas = [];
// // //   List<BaoCaoPhieuMua> get PhieuMuas => _PhieuMuas;
...
// // //       _bangBaoCaoPhieuMua = jsonList.map((e)=>BangBaoCaoPhieuMua_model.fromMap(e) ).toList();
...
//   List<BaoCaoPhieuMuaModel> _BaoCaoPhieuMua = [];

//   List<BaoCaoPhieuMuaModel> get baoCaoPhieuMua => _BaoCaoPhieuMua;

//   int get baoCaoPhieuMuaLength => _BaoCaoPhieuMua.length;

//   Future<List<BaoCaoPhieuMuaModel>> fecthbaoCaoPhieuMua() async {
//     final SharedPreferences prefs = await SharedPreferences.getInstance();
//     final response =
...
//     if (response.statusCode == 200) {
//       List<dynamic> jsonList = jsonDecode(response.body);
//       List<BaoCaoPhieuMuaModel> _BaoCaoPhieuMuaList =
//           jsonList.map((e) => BaoCaoPhieuMuaModel.fromMap(e)).toList();
//       _BaoCaoPhieuMua = jsonList.map((e) => BaoCaoPhieuMuaModel.fromMap(e)).toList();
//       notifyListeners();
//       return _BaoCaoPhieuMuaList;
//     } else {
//       throw Exception('Failed to load data');
//     }
//   }
